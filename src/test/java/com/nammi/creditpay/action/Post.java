...
import test.creditpay.com.bill99.mgw.util.Base64Binrary;
import test.creditpay.com.bill99.mgw.util.MyX509TrustManager;
import test.creditpay.com.bill99.mgw.util.ParseUtil;
...
public class Post{
	 ...
	 * 向指定URL发送POST方法的请求
	 * @param url	发送请求的URL
	 * @param tr1XML xml格式的请求字符串
	 * @param transInfo	
	 * @param jksPath jks文件的路径
	 * @return	URL所代表远程资源的响应
	 * @throws Exception
	 */
	public static HashMap sendPost(String url,String tr1XML,TransInfo transInfo, String jksPath, String merchantId) throws Exception{
        ...
        //方案2：如果是tomcat，则catalina.sh增加：-Djsse.enableSNIExtension=false
		ParseUtil parseUtil =new ParseUtil();
		OutputStream out = null;
		HashMap respXml = null;
		
		//获取证书路径
		File certFile = new File(jksPath);
		...
		try
	    {
		    ...
		    //设置通用的请求属性：商户编号+密码
			String authString = merchantId + ":" + "vpos123";
			...
			respXml= parseUtil.parseXML(reqData,transInfo);//给解析XML的函数,传递快钱返回的TR2的XML数据流
